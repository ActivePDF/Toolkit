...
intResult = oTK.OpenOutputFile(strPath & "Toolkit.Watermark.pdf")
If intResult = 0 Then
    ...
    If intResult = 0 Then
        ...
        oTK.SetTextColor 168, 0, 0, 0, -1
        oTK.PrintText (612 - oTK.GetTextWidth(stampText)) / 2, (792 - oTK.GetTextHeight(stampText)) / 2, stampText, -1
